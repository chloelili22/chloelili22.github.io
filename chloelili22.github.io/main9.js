...
//
function brushableScatterplot9(data9) {
...
// function brushableScatterplot9(9) {
//     var margin = { top: 30, right: 150, bottom: 80, left: 80 },
//         width = 960 - margin.left - margin.right,
//         height = 500 - margin.top - margin.bottom,
//         tooltip = { width: 100, height: 100, x: 10, y: -30 };
...
//         var values = data9.filter(isBrushed)
...
//         </div>
//         `
//         const text = document.querySelector("#data9_2");
//         text.innerHTML = content
...
//     const scatter = brushableScatterplot3(data9);
//     const bar = barChart(data9);
